...
class DataContainer(object):
    ...
    def __mult__(self, x, y):
        return _ala.DataContainer___mult__(self, x, y)
...
class MathClass(DataContainer):
    ...
    def __len__(self):
        return _ala.MathClass___len__(self)

    def __mult__(self, x, y):
        return _ala.MathClass___mult__(self, x, y)
    ...
    def __init__(self):
        _ala.MathClass_swiginit(self, _ala.new_MathClass())
